...
describe('R4-1 八维属性结构（终战档基线，GAME-DESIGN §5；R4-8 平衡定稿修订）', () => {
  const BASELINE: Array<[string, number, number, number, number, number, number, number, number]> = [
    ...
    ['swordsman', 32, 13, 0, 11, 5, 17, 16, 8],
    ['spearman', 33, 15, 0, 13, 5, 11, 13, 7],
    ['axeman_enemy', 35, 18, 0, 11, 5, 11, 12, 6],
    ['hammerman', 33, 16, 0, 14, 6, 10, 12, 6],
    ['archer_enemy', 30, 13, 0, 9, 5, 12, 15, 7],
    ['mage_enemy', 27, 12, 14, 7, 15, 12, 15, 7],
    ['boss', 50, 21, 0, 12, 8, 12, 16, 4]
  ];
